...
def create_application() -> FastAPI:
    ...
    def on_startup():
        ...
        try:
            ...
            logger.warning(f"Failed to create database tables on startup: {e}")
            logger.warning("The database will be created when first accessed if PostgreSQL is available")
